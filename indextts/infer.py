...
class IndexTTS:
    ...
    # 原始推理模式
    def infer(self, audio_prompt, text, output_path, verbose=False, max_text_tokens_per_sentence=120,silence_duration=0.0, split_mode="sentence", **generation_kwargs):
        ...
        if split_mode == "sentence":
            ...
            sentences = self.tokenizer.split_sentences_ex(text)
        else:
