...
class ConfigService:
    ...
    def _load_config(self):
        ...
        if not os.path.exists(self.config_file):
            # 默认配置
            default_config = {
                "global_settings": {"silence_duration": 0.3,"seed": 0, "tts_version": 1, "max_text_tokens_per_sentence": 80},
                "speaker_settings": {},
            }
    ...
    def get_audio_settings(self, speaker=None):
        ...
        default_settings = {"silence_duration": 0.3, "seed": 0, "tts_version": 1, "max_text_tokens_per_sentence": 80}
